public class Vehicle {
    ...
    public void pickUp(Queue<Person> people) {
        System.out.println(this.getClass() + " Picking up " + people.getLength() + " passengers");
    ...
    public static void doUnitTests() {
        ...
        for (int i=0; i < 5; i++) {
            people.enqueue(new Person(new Location(i*1.0,1*1.0), new Location(i*2.0,1*2.0), "home", "destination"));
        }
        v.pickUp(people);
